...
exports.FacadeServiceV2 = void 0;
...
class FacadeServiceV2 extends pip_services3_rpc_nodex_1.RestService {
    constructor() {
        super();
        this._aboutOperations = new pip_services3_rpc_nodex_2.AboutOperations();
