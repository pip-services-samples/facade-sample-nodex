...
class ClientFacadeFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        super();
...
ClientFacadeFactory.SettingsNullClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services-settings", "client", "null", "*", "1.0");
ClientFacadeFactory.AccountsMemoryClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services-accounts", "client", "memory", "*", "1.0");
ClientFacadeFactory.PasswordNullClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services-passwords", "client", "null", "*", "1.0");
ClientFacadeFactory.RolesMemoryClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services-roles", "client", "memory", "*", "1.0");
ClientFacadeFactory.SessionsMemoryClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services-sessions", "client", "memory", "*", "1.0");
ClientFacadeFactory.EmailSettingsMemoryClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services-emailsettings", "client", "memory", "*", "1.0");
ClientFacadeFactory.SitesMemoryClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services-sites", "client", "memory", "*", "1.0");
ClientFacadeFactory.InvitationsNullClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor("pip-services-invitations", "client", "null", "*", "1.0");
ClientFacadeFactory.BeaconsMemoryClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor("beacons", "client", "memory", "*", "1.0");
